...
const links = [
    ...
    { to: "/fournisseur/produits", label: "Mes Produits", icon: <Package size={20} /> },
    ...
    { to: "/fournisseur/profil", label: "Mon Profil", icon: <User size={20} /> },
];
    ...
    return (
        <aside className="w-64 min-h-screen bg-white shadow-lg flex flex-col py-8 px-4">
            <div className="flex items-center gap-2 mb-10">
                ...
                <span className="font-extrabold text-2xl tracking-tight text-green-800">Fournisseur</span>
            </div>
