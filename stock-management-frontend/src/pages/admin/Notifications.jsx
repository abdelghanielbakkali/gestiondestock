...
import { Bell, AlertTriangle, UserPlus, Trash2 } from "lucide-react";
...
export default function Notifications() {
  ...
  const getIcon = (type) => {
    if (type === "stock_bas") return <AlertTriangle className="text-red-500" />;
    if (type === "demande_creation") return <UserPlus className="text-blue-600" />;
    ...
    <div className="max-w-3xl mx-auto mt-6 px-4">
      <div className="flex justify-between mb-4">
        ...
        >
          ...
          <option value="demande_creation">Demande de création</option>
        </select>
      </div>
        ...
        {notifications.map((notif) => (
          ...
          >
            ...
            <div className="flex-1">
              <div className="font-semibold">{notif.titre || "Notification"}</div>
